...
pub mod feedback_loops; // config-load MIDI feedback-loop detection
pub mod loader;
pub mod midi_channel; // 1-indexed channel serde helpers
...
pub mod types;
pub mod u8_string_map; // TOML-compatible serde for HashMap<u8, _> fields
pub mod validation;
