...
| fxprof-processed-profile | 0.8.1 | Apache-2.0 OR MIT |
...
| ittapi-sys | 0.4.0 | BSD-3-Clause OR GPL-2.0 |
| java-locator | 0.1.9 | Apache-2.0 OR MIT |
| jni | 0.21.1 | Apache-2.0 OR MIT |
| jni | 0.22.4 | Apache-2.0 OR MIT |
| jni-macros | 0.22.4 | Apache-2.0 OR MIT |
| jni-min-helper | 0.3.2 | Apache-2.0 OR MIT |
...
| micromath | 1.1.1 | Apache-2.0 OR MIT |
| midi-msg | 0.9.0 | MIT |
| midir | 0.11.0 | MIT |
...
| rustix-linux-procfs | 0.1.1 | Apache-2.0 OR Apache-2.0 WITH LLVM-exception OR MIT |
...
This file lists license *identifiers*. For the complete license text of
each crate, run `cargo license --all-features --avoid-dev-deps` locally
(the same inputs used to generate this list), or visit the crate on
<https://crates.io> / its source repository.

## Regeneration

Generated from Cargo.lock by `scripts/gen-third-party-licenses.sh`.
Re-run it after any dependency change; CI fails if this file is stale.
