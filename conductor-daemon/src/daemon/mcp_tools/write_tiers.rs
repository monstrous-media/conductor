...
//! ADR-045 D2 — risk-tier classification for write-tier MCP tools.
//!
...
//! IDENTICAL to the pre-split classification (commercial placement never
//! re-tiers). Definitions live in `definitions_write.rs`
...
pub(super) fn write_tool_risk_tier(tool_name: &str) -> Option<ToolRiskTier> {
    Some(match tool_name {
        "conductor_create_endpoint" => ToolRiskTier::ConfigChange, // ADR-035
        ...
        "conductor_batch_changes" => ToolRiskTier::ConfigChange, // Batch operations
        ...
        "conductor_render_artifact" => ToolRiskTier::ArtifactRender,
        "conductor_dismiss_artifact" => ToolRiskTier::ArtifactRender,
        "conductor_switch_mode" => ToolRiskTier::Stateful,
        "conductor_set_mode" => ToolRiskTier::Stateful, // ADR-040 4c
        "conductor_unlock_mode" => ToolRiskTier::Stateful, // ADR-040 4c
        "conductor_switch_profile" => ToolRiskTier::Stateful, // Phase 1
        ...
        "conductor_send_midi" => ToolRiskTier::HardwareIO,
